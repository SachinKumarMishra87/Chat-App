...
const EditUserDetails = ({ close, user }) => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            const URL = `${import.meta.env.VITE_BACKEND_URL}/api/update-userDetails`; // Yeh sahi hai
            ...
            console.log("responseData From Edit", response)
        } catch (error) {
        ...
        <section className='fixed top-0 left-0 w-full h-full bg-neutral-900 bg-opacity-70 z-50 flex items-center justify-center'>
            <div className="bg-white p-4 m-1 rounded w-full max-w-sm shadow-lg ">
                <div className="flex justify-between w-full">
                    ...
                    <div className='text-red-950 hover:text-red-700' onClick={close}>
                        <FiDelete size={25} />
                    </div>
                </div>
